    ...
    <CommonTable :isFull="false">
        ...
        <template #action>
            ...
            <div style="float: right">
                ...
                <el-button size="mini" type="default" @click="leadingOutBtn">导出</el-button>
            </div>
        </template>
        ...
        <el-table size="mini" :data="tableData.FormData" style="width: 100%" stripe :border="true" element-loading-text="loading...">
            ...
            <el-table-column label="操作" align="center">
                <template #default="scope">
                    <!-- 新增 -->
                    <el-button size="mini" type="text" @click="putOnBtn(scope.$index, scope.row)">上架</el-button>
                    <el-button size="mini" type="text" @click="putOffBtn(scope.$index, scope.row)">下架</el-button>
...
<script setup>
    ...
    //列表数据
    const { searchData, tableData, queryBtn, resetBtn, handleEdit, handleDelete, handleSizeChange, currentChange, getTableData, leadingInBtn, leadingOutBtn } = tableConfig(
        timeLimitUnitList,
        riskRatingList,
        areaList
    );
