    ...
    <BcPageForm :title="otherData.pageTitle" :model="addFormData.formData" :rules="rules" ref="addForm">
        ...
        <ItemBox title="新增理财子产品信息">
            ...
            <el-row>
                ...
                <el-form-item label="产品类型别名" prop="categoryAlias">
            ...
            <el-row>
                ...
                <el-form-item label="机构别名">
                    <el-input placeholder="请输入机构别名"></el-input>
                </el-form-item>
            </el-row>
            ...
            <!-- 新增 -->
            <el-row>
                <el-form-item label="收益率文案备注详情">
                    <el-input placeholder="请输入收益率文案备注详情"></el-input>
                </el-form-item>
            </el-row>
            ...
            <el-row>
                <!-- 新增 -->
                <el-form-item label="利率曲线图类型">
                    <BcSelect :list="proTypeAddList"></BcSelect>
                </el-form-item>
            </el-row>

            <el-row style="margin-bottom: 50px">
                <!-- 七日年化收益 -->
                <sevenIncome></sevenIncome>
            </el-row>
        ...
        <ItemBox title="配置信息">
            <configInfo :addFormData="addFormData" :SelectData="aaa"></configInfo>
            <!-- <el-row>
...
<script setup>
    ...
    import sevenIncome from "./modules/sevenIncome";
    import fixedIncome from "./modules/fixedIncome";
