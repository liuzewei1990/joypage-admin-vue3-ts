<!-- 已审核的帖子 -->
<template>
    <BcTable ref="BcTable" :isFill="false" :tableConfig="tableConfig" @GetApiData="GetapiData" @selection-change="selectionChange">
        <!-- 审核：查询条件 -->
        <template #search>
        ...
        <template v-slot:action>
            ...
            <el-button-group style="float: right; margin: 0px 10px 0px 0px">
                <el-button size="mini" type="primary">自动审核</el-button>
                <el-button size="mini" type="primary" @click="reshenhe">审核</el-button>
                ...
                <!-- 未审核的帖子不应该允许设置官方推荐 -->
                <!-- <el-button size="mini" type="primary" @click="tuijian">设置官方推荐帖</el-button> -->
            </el-button-group>
        </template>
...
<script setup>
    ...
    // 操作区
    const { selectionChange, reshenhe, pinglun, up, down, zhuanfa, pinglun_show, fenxiang, tuijian, selectItems } = createActionEvent();
