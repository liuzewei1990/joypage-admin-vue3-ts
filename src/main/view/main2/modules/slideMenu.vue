    ...
    <section class="slide-menu-container">
        ...
        <div class="sub-slide" v-show="menuList[menuListCode].children.length > 0">
            ...
            <div class="sub-slide-title">
                <p>{{ menuList[menuListCode].text }}</p>
            </div>
        ...
        <div class="sub-slide sub-slide-copy" v-show="mouseoverOneMenuShow && menuList[mouseoverOneMenuIndex].children.length > 0" @mouseenter="mouseoverEnter2" @mouseleave="mouseoutLeave2">
            <!-- 标题 -->
            <div class="sub-slide-title">
                <p>{{ menuList[mouseoverOneMenuIndex].text }}</p>
            </div>
            ...
            <div class="sub-slide-main">
                <el-menu
                    ...
                    v-if="mouseoverOneMenuShow"
                    :default-openeds="defaultOpeneds2"
                    class="finsuit-el-menu"
                    @select="handleMenuSelectHover"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            // 子菜单默认展开的数组
            defaultOpeneds2() {
                const a = this.menuList[this.mouseoverOneMenuIndex].children.map((item, index) => {
                    return item.id;
                });
                console.log(a);
                return a;
